...
WavesInABox is a full-fledged real-time wavefront simulator, that uses OpenGL to represent the waves in 3D. The simulation uses a finite difference method to simulate the [wave equation](https://en.wikipedia.org/wiki/Wave_equation). To achieve good performance compute shaders are utilized.
